      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-sm">
              We are a leading mobile reseller platform providing the best
              second-hand devices. Our mission is to ensure quality and
          ...
          <div>
            ...
            <ul className="text-sm">
              <li className="mb-2">
                <span>📍 123 Main St, City Name</span>
              </li>
              <li className="mb-2">
                <span>📞 +123 456 7890</span>
              </li>
              <li className="mb-2">
                <span>✉️ info@mobilbazzar.com</span>
              </li>
            </ul>
            <div>
        ...
        <div className="mt-8 text-center border-t border-gray-700 pt-4">
          <p className="text-sm">
            &copy; 2024 Mobile Reseller. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
